...
testcontainers-go fixtures, PostgreSQL 18.3 + NATS 2.12.5 test helpers
...
git clone https://github.com/zarishsphere/zs-pkg-go-testing.git
cd zs-pkg-go-testing
...
See [docs.zarishsphere.com/api/zs-pkg-go-testing](https://docs.zarishsphere.com/api/zs-pkg-go-testing) for the full OpenAPI 3.1 specification.
